...
print(f"🎯 將訓練 {len(selected_files)} 個檔案：")
...
selected_file_list = "trainlog/selected_for_training.txt"  # ✅ 改這裡
...
with open(f"trainlog/training_batch_{timestamp}.txt", "w") as f:  # ✅ 改這裡
    for fpath in selected_files:
        f.write(fpath.replace("\\", "/") + "\n")
